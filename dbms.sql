...
-- Dumping data for table teamssfc.django_migrations: ~20 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `Contact Number` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `Registration Number` varchar(10) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `student` (`First Name`, `Last Name`, `Contact Number`, `Registration Number`, `Session`, `Username`) VALUES
...
CREATE TABLE IF NOT EXISTS `teacher` (
  ...
  `Contact Number` varchar(12) COLLATE utf8_bin DEFAULT NULL,
  `Username` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `teacher` (`First Name`, `Last Name`, `Designation`, `Code`, `Contact Number`, `Username`) VALUES
...
CREATE TABLE IF NOT EXISTS `team_student` (
  `Team ID` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `RegistrationNumber` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  KEY `Team Student ID` (`Team ID`),
  KEY `Registration Number` (`RegistrationNumber`),
  CONSTRAINT `FK_team_student_student` FOREIGN KEY (`RegistrationNumber`) REFERENCES `student` (`Registration Number`),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `Type` enum('Student','Teacher') COLLATE utf8_bin NOT NULL,
  `Email` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`Username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table teamssfc.users: ~27 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`Username`, `Pasword`, `Type`, `Email`) VALUES
	('Mustafa01', 'gd45srw', '', NULL),
	('Shifath420533', 'hexag0N', '', NULL),
	('af', '1234', '', NULL),
	('ahamedf', 'vx2v5x4v', '', NULL),
	('aishatasnim', '45asf645a68', '', NULL),
	('biswapriyo', '2q542r54254', '', NULL),
	('dipta29', 'iloveylyl', '', NULL),
	('enam11', 's124f54q54f', '', NULL),
	('firzoM', 'asdas45das4', '', NULL),
	('fs', 'sd', '', NULL),
	('helloafsdf', '1234', '', NULL),
	('mahfuzA', 'h4hg568443w', '', NULL),
	('masum01', 'cv45n75cv78', '', NULL),
	('moqsad1', 'h14d54g75w', '', NULL),
	('nabil48', '7425dg5s4#', '', NULL),
	('rafirafi', 'rwqrqw455', '', NULL),
	('sabir_99', 'q5642wr89qw87', '', NULL),
	('saif01', 'ert424rt54r', '', NULL),
	('saleh123', '434754g5ds4g5', '', NULL),
	('shouvik075', '112398g8', '', NULL),
